...
void CLabel::SetHiddenHelp(COLORREF crHiddenHelp)
{
	m_bHiddenHelp  = TRUE;
...
void CLabel::OnLButtonUp(UINT nFlags, CPoint point) 
{
	...
	if(strLink.Find(0x40) > 0)
	{
		strLink = CString("mailto:") + (LPCTSTR)strLink;
	}
