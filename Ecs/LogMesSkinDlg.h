...
public:
	...
	CStaticTransparent m_lblMESLuggno;
	CEdit			   m_edtMESLuggno;
	CEdit			   m_edtMESBarcode;
	CEdit			   m_edtMESFromloc;
	CEdit			   m_edtMESToloc;
	...
	CComboBoxWrapper m_cbxMesLogJobkind;
	CStaticTransparent m_lblMesLogJobkind;
	CStaticTransparent m_lblMesLogBarcode;
	CStaticTransparent m_lblMesLogFrLoc;
	CStaticTransparent m_lblMesLogToLoc;
