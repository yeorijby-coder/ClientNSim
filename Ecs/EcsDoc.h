...
public:
	...
	CString				m_nLayoutLg[1000];
	CString				m_nLayoutPl[1000];
	CString				m_nLayoutCm[1000];
...
public:
	...
	CViewMesListDlg* m_pViewMesListDlg;
...
public:
	...
	BOOL GetQueryInsertClientLog(CString pWIN_ID, CString pLUGG_NO, CString pBARCODE, CString pMESSAGE);
	BOOL IsFireDlg();
