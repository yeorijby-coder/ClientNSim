...
public:
	...
	CStaticTransparent m_lblBcrRcvVal;
...
public:
	...
	CComboBoxWrapper m_cbxLogBcrMcNo;
	CComboBoxWrapper m_cbxLogBcrNo;
	CStaticTransparent m_lblLogBcrWhTyp;
	CComboBoxWrapper m_cbxLogBcrSta;
	CStaticTransparent m_m_lblLogBcrSta;
};
