...
public:
	BOOL IsValidataEditData(CString pBcrBottom);

public:
	//label
	CStaticTransparent m_lblBarcode;
	CStaticTransparent m_lblBcrSta;

	CStaticTransparent m_lblBcrTrackNo;
	CStaticTransparent m_lblBcrSuspend;
	CStaticTransparent m_lblBcrUpdDt;
	...
	CEdit m_edtBcrUpdDt;
	CEdit m_edtCvStoReady;
	//
	CListBox m_listBoxBcrListRcvVal;
	CListBox m_listBoxBcrListUpdDt;
	...
	CString GetQrySelectCV_STATUS_CCD();
